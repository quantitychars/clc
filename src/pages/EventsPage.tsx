...
export default function EventsPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      {/* Add Interests Modal */}
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/50 p-4" role="dialog" aria-label="Select interests">
          <div className="w-full max-w-sm rounded-lg bg-card p-6 shadow-xl animate-fade-in">
            <h3 className="text-lg font-bold text-foreground mb-4">Select Your Interests</h3>
